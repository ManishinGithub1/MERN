...
import { Box, Heading, HStack, IconButton, Image, Input, Modal, ModalBody,ModalFooter,Button, ModalCloseButton, ModalContent, ModalHeader,VStack,ModalOverlay, Text, useColorModeValue, useDisclosure, useToast } from '@chakra-ui/react';
...
const ProductCard = ({product}) => {
  ...
  return (
    ...
    <Box p={6}>
    <Heading as ='h3' fontSize='xl' mb={2}>{product.name}</Heading> 
    <Text fontWeight='bold' fontSize='xl' color={textColor} mb={4}>${product.price}</Text>

    <HStack spacing={2}>
      <IconButton icon={<EditIcon />} onClick={onOpen} colorSqheme='blue' />
